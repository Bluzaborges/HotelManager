...
Feature: CancelReservation
	In order to cancel and not enjoy from my reservation
	As a user
	I want to perform a logical exclusion
...
Scenario: Cancel one reservation
	Given my user is registered as "John"
	And I cancel the reservation number 3
	...
	Then the reservations should be
		...
		| 03          | True    |
		| 04          | False   |
	And I am fined 20.0% of the reservation value