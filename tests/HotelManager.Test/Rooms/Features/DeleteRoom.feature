@Room
Feature: DeleteRoom
	In order to make a new room unavailable to be reserved
	As a admin
...
Scenario: Delete one room
	Given I delete the room "3B"
...
Scenario: Delete room with active reservations
	Given I delete the room "1A"
	When I execute the room delete action
